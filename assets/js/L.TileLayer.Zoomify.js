...
var options = L.setOptions(this, options);
	...
	//var southEast = map.unproject([0, this.options.height], options.maxNativeZoom);
	//var northEast = map.unproject([this.options.width, 0], options.maxNativeZoom);
    ...
    //options.bounds = new L.LatLngBounds(northEast, southEast);
